function [scenario, egoVehicle] = Prasad(speed, positions, obstacleX, obstacleY, ObstaclecarX, ObstaclecarY)
    ...
    positionVehicle = [ObstaclecarX; ObstaclecarY * ones(size(ObstaclecarX))]';
    egoVehicle = vehicle(scenario, ...
        'ClassID', 1, ...
        'Position', [103.994048300763 13.077549886967 0], ...
        'FrontOverhang', 0.9);
